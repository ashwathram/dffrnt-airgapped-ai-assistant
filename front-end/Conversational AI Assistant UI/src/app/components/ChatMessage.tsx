...
import { Copy, ThumbsUp, ThumbsDown, RotateCcw, ExternalLink, ChevronDown, ChevronUp, AlertCircle } from "lucide-react";
  ...
  if (message.noSource || message.insufficientContext) {
    return (
      <div className="flex justify-center">
        <div
          className="flex items-center gap-2 px-4 py-3 rounded-xl text-xs max-w-lg text-center"
          style={{
