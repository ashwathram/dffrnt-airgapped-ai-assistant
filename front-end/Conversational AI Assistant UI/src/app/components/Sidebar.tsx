...
export function Sidebar({
  ...
  return (
    ...
    >
      ...
      {/* Nav actions */}
      <div className="px-3 pt-6 pb-2 flex flex-col gap-1.5 flex-shrink-0">
        <button
          onClick={onNewChat}
          title="New chat"
            ...
            return (
              <div key={group} className="mb-4">
                <button
                  ...
                  className="flex items-center gap-1.5 px-1 py-1 text-xs w-full mb-1"
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="flex items-start gap-2.5 px-3 py-2.5 text-left flex-1 min-w-0"
                        ...
                        {/* More button */}
                        {!isRenaming && (
                          <div className="relative flex-shrink-0 self-center pr-1.5">
                            <button
