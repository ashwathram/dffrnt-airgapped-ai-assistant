...
export function TagManagerModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(9,26,41,0.5)" }}>
      <div
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4 flex flex-col gap-3" style={{ scrollbarWidth: "thin" }}>
                  ...
                  <div className="px-4 pb-3 pt-2 flex flex-col gap-2">
                    ...
                    <div className="flex gap-2 mt-1">
                      <input
                        ...
                        className="flex-1 px-3 py-1.5 text-xs rounded-lg border border-border bg-input-background outline-none focus:ring-1 focus:ring-ring/40"
                      />
                      <button
          ...
          {/* Add new type */}
          {showNewTypeForm ? (
            <div className="rounded-xl border-2 border-dashed border-border p-4 flex flex-col gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl border-2 border-dashed border-border text-sm text-muted-foreground hover:text-foreground hover:border-foreground/20 transition-colors"
            >
              <Plus size={14} />
              New tag type
            </button>
